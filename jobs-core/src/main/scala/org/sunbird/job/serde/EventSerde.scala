...
class EventDeserializationSchema[T <: Event](implicit ct: ClassTag[T]) extends KafkaDeserializationSchema[T] {
...
class EventSerializationSchema[T <: Event : Manifest](topic: String) extends KafkaSerializationSchema[T] {
